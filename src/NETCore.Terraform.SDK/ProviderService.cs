...
namespace NETCore.Terraform.SDK
{
    ...
    {
        public override Task<ApplyResourceChange.Types.Response> ApplyResourceChange(
            ApplyResourceChange.Types.Request request, ServerCallContext context)
        {
            return base.ApplyResourceChange(request, context);
        }

        public override Task<Configure.Types.Response> Configure(
        ...
        public override Task<GetProviderSchema.Types.Response> GetSchema(
            GetProviderSchema.Types.Request request, ServerCallContext context)
        {
            return base.GetSchema(request, context);
        }

        public override Task<ImportResourceState.Types.Response> ImportResourceState(
        ...
        public override Task<UpgradeResourceState.Types.Response> UpgradeResourceState(
            UpgradeResourceState.Types.Request request, ServerCallContext context)
        {
            return base.UpgradeResourceState(request, context);
        }

        public override Task<ValidateDataSourceConfig.Types.Response> ValidateDataSourceConfig(
        ...
        public override Task<ValidateResourceTypeConfig.Types.Response> ValidateResourceTypeConfig(
